...
naf_folder="data/pilot_data/naf" # where is the input folder with NAF files?
...
cd scripts
bash prediction_on_unseen_data.sh $input $output > $out_folder/log.out 2> $out_folder/log.err &
cd ..
